...
const searchPost = (parent, context) => __awaiter(void 0, void 0, void 0, function* () {
    const myclient = (0, dev_config_1.client)(process.env.HASUNA_ENDPOINT, process.env.HASUNA_SECRET);
    try {
